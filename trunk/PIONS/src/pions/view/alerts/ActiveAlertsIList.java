...
public class ActiveAlertsIList extends AbstractAlertsIList {
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(pions.PIONS.class).getContext().getResourceMap(ActiveAlertsIList.class);
